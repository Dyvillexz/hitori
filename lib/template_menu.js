...
async function setTemplateMenu(Dyvillexz, type, m, prefix, setv, db, options = {}) {
...
╰──────❍`
	...
	if (type == 1 || type == 'buttonMessage') {
		await Dyvillexz.sendButtonMsg(m.chat, {
...
╰─┬────❍
╭─┴─❍「 *BOT INFO* 」❍
├ *Nama Bot* : ${DyvillexzBot}
├ *Powered* : @${'0@s.whatsapp.net'.split('@')[0]}
├ *Owner* : @${owner[0].split('@')[0]}
├ *Mode* : ${Dyvillexz.public ? 'Public' : 'Self'}
